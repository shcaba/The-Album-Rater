...
sidebarLayout(
  sidebarPanel(
    ...
    fluidRow(
      column(width = 6, numericInput("wttens", "# of 10s",  value = 0.1, min = 0, max = 1, step = 0.001)),
      column(width = 6, numericInput("wt8plus", "# 8+",  value = 0.05, min = 0, max = 1, step = 0.00001))
    ),
    fluidRow(
    ...
    fluidRow(
      column(width = 6, numericInput("wttens_artist", "# of 10s",  value = 0.4, min = 0, max = 1, step = 0.001)),
      column(width = 6, numericInput("wt8plus_artist", "# 8+",  value = 0.35, min = 0, max = 1, step = 0.00001))
    ),
    fluidRow(
    ...
    tabsetPanel(
      ...
      tabPanel("Album rankings",
        ...
        tabPanel("Artist rankings",
                 value=2,
                 h4("Explore which artists have the most classics, best number of songs, and overall highest ranking based on user inputted weights."),
        ...
        tabPanel("Year summary",
                 h4("Explore which years have the most classic and great songs, as well as which years are the highest quality and have the most rated songs."),
        ...
        tabPanel("Cluster analysis",
                 ...
                 h4("Final ranking compared to the ranking metric. This comparison can reveal how closely scored albums are to each adjacent album."),
